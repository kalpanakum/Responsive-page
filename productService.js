let productService = {
  ...
  getProductById(id) {
    return this.allProducts.find(product => product.productId === id);
  },

  getProductBySku(sku) {
    return this.allProducts.find(product => product.productSku === sku);
  },

  getProductByPriceRange(minPrice, maxPrice) {
